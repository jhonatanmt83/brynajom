	...
	define([], function () {
		return function (tableId) {
			...
			$export.UpdateFooter = function (footer) {
				...
				if (showing) {
					showing.innerHTML = "Mostrando " + start + " - " + end + " de " + ($export.visibleRows.length) + " entradas";
					if ($export.visibleRows.length != $export.rows.length) {
						showing.innerHTML += " (Encontrados de " + ($export.rows.length) + " entradas)";
					}
				}
